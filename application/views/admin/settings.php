        ...
        <div class="row">
          ...
          ?>
            <div class="col-sm-4 form-group">
              <button onclick="get_email_content(<?= $email['id']; ?>);" type="button" class="btn btn-info"><?= ucwords(str_replace('_', ' ', $email['comment'])); ?></button>
            </div>
          <?php
          }
          ?>
    ...
    <form id="updateEmailContentForm" name="updateEmailContentForm" onsubmit="update_email_content(event);">
      <div class="modal-content">
        ...
        <div class="modal-body" id="email-content">
          <!-- Dynamic permissions from email-content.php -->
        </div>
      </div>
    </form>
  </div>
