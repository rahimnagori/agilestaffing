<div class="optio_raddipo">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control textarea-edit" name="description"
            required=""><?= $jobDetails['description']; ?></textarea>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <select name="job_type" class="form-control" required="">
                    ...
                    ?>
                    <option value="<?=$jobId;?>" <?= $jobDetails['job_type'] == $jobId ? 'selected' : ''; ?>>
                        <?=$jobType;?></option>
                    <?php
                        }
                    ?>
    ...
    <div class="form-group">
        ...
        <input type="date" name="last_date" class="form-control" required=""
            value="<?= date("Y-m-d", strtotime($jobDetails['last_date'])); ?>">
    </div>
    <div class="row">
