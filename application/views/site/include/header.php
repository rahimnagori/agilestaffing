        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <li class="droup_des">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <span class="img_radiuus">
                                    <img
                                        src="<?= site_url(); ?><?= (!empty($moreUserDetails) && $moreUserDetails['profile_image']) ? $moreUserDetails['profile_image'] : 'assets/site/img/img_9.png'; ?>">
                  ...
                  ?>
                        <li class="Sign_top"><a href="<?= site_url('Login') ?>" class="btn btn_theme"
                                style="background: transparent; color: var(--blue); border: 1px solid var(--blue);">Login</a>
                        </li>
