            ...
            <td align="center" valign="top">
                <table border="0" cellpadding="10" cellspacing="0" width="600"
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="top"
                                style="padding:0px; background: #f1f1f1; border-bottom: 2px solid #ff156e;">
                                <table border="0" cellpadding="0" cellspacing="10" width="100%">
                                    <tbody>
                                        <tr>
                                            <td align="center" style="text-align: center;" valign="middle"><a
                                                    style="font-family:\'Ubuntu\',sans-serif;color:#ff3000;font-weight:300;display:block;letter-spacing:-1.5px;text-decoration:none;margin-top:2px"
                                                    href="'.site_url().'"><img
                                                        src="<?= site_url(); ?>assets/site/img/logo.png"
                                                        style="padding-top:0;display:inline-block;vertical-align:middle;margin-right:0px;height:55px"
                                                        class="CToWUd" alt="<?= $PROJECT; ?> Logo"></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" width="80%">
                                                <div style="margin:0;padding:0;color:#fff;font-size:13px">Copyright ©
                                                    <?= date("Y"); ?> <a href="'.site_url().'"
                                                        style="color:white;text-decoration:none"> <?= $PROJECT; ?> </a>.
